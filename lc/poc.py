...
github ; https://github.com/aexdyhaxor/CVE-2026-41651/
...
def main():
    print("=" * 60)
    print("  CVE-2026-41651 — ""Pack2TheRoot"" => PackageKit TOCTOU Privilege Escalation")
    print("  github : https://github.com/aexdyhaxor/CVE-2026-41651/")
    print("  Author : aexdy / @imoetngawi")
    print("=" * 60)
    print()
